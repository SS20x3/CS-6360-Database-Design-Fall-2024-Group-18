...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(prog='level_k',
                    description='Generates an SQL query to run the level-k algorithm on a given dataset as well as the result of that query',
                    epilog="")
    ...
    level_k(args.filePath, args.k, args.line)